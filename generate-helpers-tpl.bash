...
CHART_NAME=$1
DEST_CHART_DIR=$2
echo "generatting _helpers.tpl with chart name=$CHART_NAME into DEST_CHART_DIR=${DEST_CHART_DIR}"
set -e
...
sed "s/<CHARTNAME>/${CHART_NAME}/g" < _helpers.tpl.tpl  > ${DEST_CHART_DIR}/templates/_helpers.tpl
